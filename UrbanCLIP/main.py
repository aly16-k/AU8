...
def create_args():
    ...
    parser.add_argument(
        "--dataset",
        type=str,
        default="Adelaide_captions",
        choices=["Adelaide_captions"],
        help="which dataset",
    )
    parser.add_argument(
...
def create_datasets(args, transform, tokenizer):
    ...
    if args.dataset == "Adelaide_captions":
        data = json.load(open("data/captions/Adelaide_captions.json", "r", encoding="utf-8"))
    else:
