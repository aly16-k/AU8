...
def create_args():
    ...
    parser.add_argument(
        "--test_file",
        type=str,
        default="./data/downstream_task/Adelaide_test.csv",
    ...
    parser.add_argument(
        "--indicator",
        type=str,
        default="Median_price_of_established_house_transfers__2023_log",
        choices=["Median_price_of_established_house_transfers__2023_log"],
        help="indicator",
    )
...
def create_datasets(args, transform):
    ...
    if args.dataset == "Adelaide":
        data = pd.read_csv("data/downstream_task/Adelaide_train.csv")
    else:
