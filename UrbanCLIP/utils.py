...
class CoCaDataset(Dataset):
    def __init__(self, list_data=None, transform=None, tokenizer=None):
        ...
        for item in list_data:
            ...
            # ).convert("RGB")
            self.img_paths.append(os.path.join("./data/images/Adelaide", item["image"]))
...
class LinearProbDataset(Dataset):
    ...
    def __init__(
        ...
        for idx, row in df_data.iterrows():
            ...
            if data_name == "Adelaide":
                _image_path = os.path.join("./data/images/Adelaide", _image_name)
            else:
                raise ValueError("data must be Adelaide")
...
if __name__ == "__main__":
    data = json.load(open("data/captions/Adelaide_captions.json", "r"))
